...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "Calisthenics box";
    public static final String YOUR_MEMBER_NAME = "Bert";
    ...
    private static void initializeGym0(Gym gym){
        //TODO 4: uncomment the next 4 lines:
         Barbell bar = new Barbell(10);//TODO 4: make a new barbell
         IndoorBike bike = new IndoorBike();//TODO 4: make a new IndoorBike
         gym.addWeight(bar);
         gym.addCardioMachine(bike);
         FitnessClass fc = new FitnessClass("Handstands", "At 12AM every day");
